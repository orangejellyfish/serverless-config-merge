...
function merge(obj, file) {
  ...
  // Assume the loaded file is a YAML file, parse it as such and merge it
...
function walk(key, obj) {
  Object.entries(obj).forEach(([k, v]) => {
    // If the key matches the search term we perform a merge. If the value is
    // a string it should match the Serverless Framework "file" variable pattern
